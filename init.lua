...
do
  ...
  require('blink.cmp').setup {
    ...
    -- Enabled here: this machine is covered by blink's prebuilt binaries, and
    -- `prefer_rust_with_warning` falls back to the Lua matcher if the download
    -- ever fails, so there's no way for it to leave completion broken.
